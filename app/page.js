...
return ( <div className="min-h-screen bg-black text-white overflow-hidden relative font-sans"> <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(180,0,0,0.18),transparent_60%)]" /> <div className="absolute inset-0 opacity-10 bg-[linear-gradient(to_bottom,transparent_0%,#ff000020_50%,transparent_100%)] animate-pulse" />

```
  <section className="relative flex min-h-screen flex-col items-center justify-center px-8 text-center">
    <div className="mb-6 text-red-500 tracking-[0.4em] text-sm uppercase">Genesis Index Protocol</div>
  ...
  <section className="relative px-8 py-32 text-center border-t border-zinc-900">
    <h2 className="text-5xl font-semibold">The First Martian Economic Primitive</h2>
